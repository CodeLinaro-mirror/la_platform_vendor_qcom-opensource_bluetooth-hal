...
#define NEW_UART_IPC_TX_LOG_PREFIX  "ramdump_new_bt_uart_ipc_tx_"

#define UART_IPC_RX_LOG_PREFIX  "ramdump_bt_uart_ipc_rx_"
#define NEW_UART_IPC_RX_LOG_PREFIX  "ramdump_new_bt_uart_ipc_rx_"

#define UART_IPC_STATE_LOG_PREFIX "ramdump_bt_uart_ipc_state_"
#define NEW_UART_IPC_STATE_LOG_PREFIX "ramdump_new_bt_uart_ipc_state_"

#define UART_IPC_PWR_LOG_PREFIX "ramdump_bt_uart_ipc_pwr_"
#define NEW_UART_IPC_PWR_LOG_PREFIX "ramdump_new_bt_uart_ipc_pwr_"

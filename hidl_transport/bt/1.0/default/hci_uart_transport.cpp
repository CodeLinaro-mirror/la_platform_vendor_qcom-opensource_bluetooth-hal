...
uint8_t max_uart_baudrate()
{
  uint8_t userial = 0xFF;
  char value[PROPERTY_VALUE_MAX] = {'\0'};
  property_get("persist.vendor.bluetooth.uart_baudrate", value, "3000000");

  switch (atoi(value)) {
    case 300:
      userial = USERIAL_BAUD_300;
      break;
    case 600:
      userial = USERIAL_BAUD_600;
      break;
    case 1200:
      userial = USERIAL_BAUD_1200;
      break;
    case 2400:
      userial = USERIAL_BAUD_2400;
      break;
    case 9600:
      userial = USERIAL_BAUD_9600;
      break;
    case 19200:
      userial = USERIAL_BAUD_19200;
      break;
    case 57600:
      userial = USERIAL_BAUD_57600;
      break;
    case 115200:
      userial = USERIAL_BAUD_115200;
      break;
    case 230400:
      userial = USERIAL_BAUD_230400;
      break;
    case 460800:
      userial = USERIAL_BAUD_460800;
      break;
    case 921600:
      userial = USERIAL_BAUD_921600;
      break;
    case 1000000:
      userial = USERIAL_BAUD_1M;
      break;
    case 2000000:
      userial = USERIAL_BAUD_2M;
      break;
    case 3000000:
      userial = USERIAL_BAUD_3M;
      break;
    case 3200000:
      userial = USERIAL_BAUD_3_2M;
      break;
    case 4000000:
      userial = USERIAL_BAUD_4M;
      break;
    default:
      ALOGE( "%s: unsupported baud %s", __func__, value);
      userial = USERIAL_BAUD_3M;
      break;
  }
  return userial;
...
int HciUartTransport::GetBaudRate(void)
{
  ...
  if (ctrl_fd_ == -1) {
    ALOGE("%s: uart port(%s) has not been opened", __func__, uart_device_);
    return -1;
  }
...
#ifdef TARGET_QTI_VM
    /* In HGY, UART driver can only support 3Mbps, while not 3.2Mbps */
      return max_uart_baudrate();
      break;
#endif
    case BT_SOC_MOSELLE:
      return (uint8_t) USERIAL_BAUD_3_2M;

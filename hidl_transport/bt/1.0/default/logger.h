...
#define NEW_SOC_DUMP_PREFIX "ramdump_new_bt_fw_crashdump_"
#define SOC_DUMP_PATH LOG_COLLECTION_DIR "%s" LOGS_TS FW_DUMP_EXTN
#define SNOOP_FILE_PATH  LOG_COLLECTION_DIR "%s" LOGS_TS SNOOP_EXTN
#define UART_IPC_TX_LOGS_DEST_PATH  LOG_COLLECTION_DIR "%s" LOGS_TS LOGS_EXTN
#define UART_IPC_RX_LOGS_DEST_PATH LOG_COLLECTION_DIR "%s" LOGS_TS LOGS_EXTN
#define UART_IPC_STATE_LOGS_DEST_PATH LOG_COLLECTION_DIR "%s" LOGS_TS LOGS_EXTN
#define UART_IPC_PWR_LOGS_DEST_PATH LOG_COLLECTION_DIR "%s" LOGS_TS LOGS_EXTN
#define UART_LOGS_DEST_PATH LOG_COLLECTION_DIR "%s" LOGS_TS LOGS_EXTN
#define BT_STATE_FILE_PATH LOG_COLLECTION_DIR "%s" LOGS_TS LOGS_EXTN
